...
defmodule OddittApiClient.Connection do
  @moduledoc """
  Handle Tesla connections for OddittApiClient.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, OddittApiClient.Connection,
        base_url: "https://api.odditt.com",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :odditt_api_client,
        :base_url, "https://api.odditt.com"
  """
  ...
  @doc """
  Configure a OddittApiClient client.

  ### Parameters

  - `options`: an optional keyword list of OddittApiClient.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:odditt_api_client, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - OddittApiClient 1.0.0 - elixir"
        )
      )
